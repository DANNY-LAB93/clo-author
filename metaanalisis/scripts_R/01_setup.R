...
source(here("metaanalisis", "scripts_R", "functions", "backtransform_prop.R"))
source(here("metaanalisis", "scripts_R", "functions", "pool_stratum.R"))
source(here("metaanalisis", "scripts_R", "functions", "collapse_category.R"))
source(here("metaanalisis", "scripts_R", "functions", "format_percent_ci.R"))
...
data_path    <- here("metaanalisis", "datos", "phage_therapy_extraction_dataset.csv")
output_dir   <- here("metaanalisis", "scripts_R", "output")
