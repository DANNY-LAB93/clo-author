...
source(here::here("metaanalisis", "scripts_R", "01_setup.R"))
source(here::here("metaanalisis", "scripts_R", "02_data_preparation.R"))
source(here::here("metaanalisis", "scripts_R", "03_descriptive.R"))
source(here::here("metaanalisis", "scripts_R", "04_estimation.R"))
source(here::here("metaanalisis", "scripts_R", "05_robustness.R"))
source(here::here("metaanalisis", "scripts_R", "06_falsification.R"))
source(here::here("metaanalisis", "scripts_R", "07_figures.R"))
source(here::here("metaanalisis", "scripts_R", "08_tables.R"))
source(here::here("metaanalisis", "scripts_R", "09_table1_characteristics.R"))
source(here::here("metaanalisis", "scripts_R", "10_grade.R"))
source(here::here("metaanalisis", "scripts_R", "12_risk_of_bias.R"))
source(here::here("metaanalisis", "scripts_R", "11_manifest.R"))
...
source(here::here("metaanalisis", "scripts_R", "14_prisma_counts.R"))
...
source(here::here("metaanalisis", "scripts_R", "15_outcome_definitions.R"))
...
source(here::here("metaanalisis", "scripts_R", "16_eradication_site_split.R"))
...
source(here::here("metaanalisis", "scripts_R", "13_tex_macros.R"))
