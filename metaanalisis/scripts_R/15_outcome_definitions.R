...
dat <- readRDS(file.path(here::here("metaanalisis", "scripts_R", "output"), "dat_analysis.rds"))
raw <- readr::read_csv(
...
saveRDS(spread, file.path(here::here("metaanalisis", "scripts_R", "output"), "followup_spread.rds"))
