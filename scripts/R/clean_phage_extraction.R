...
#          (data/raw/phage_therapy_extraction_raw.csv), validate it against
...
#
# Inputs:  data/raw/phage_therapy_extraction_raw.csv
# Outputs: data/cleaned/phage_therapy_extraction_dataset.csv
#          data/cleaned/phage_therapy_extraction_dataset.rds
#          data/cleaned/phage_therapy_extraction_coverage_summary.rds
#
...
# ---- Paths --------------------------------------------------------------
raw_path     <- here("data", "raw", "phage_therapy_extraction_raw.csv")
out_dir      <- here("data", "cleaned")
