...
Background: MDR, XDR and pandrug-resistant \textit{Pseudomonas aeruginosa} is a WHO priority pathogen with few options; phage therapy has expanded without stratified synthesis. Methods: PRISMA 2020 meta-analysis of proportions (binomial-normal GLMM), stratified by resistance class, difficult-to-treat resistance, route and modality. Results: \PrismaPooledArms pooling-eligible arms (\PrismaPooledStudies studies, \PatientsAnalysed patients) gave clinical success \CsOverallEstCI, a proportion of the published record, not of treated patients. \CellsPooled of \CellsTotal cells met threshold, including MDR \CsResMDREstCI. The highest estimate in the review, \CsResNotClassifiableEst, falls in the stratum defined by \emph{absent} resistance documentation. XDR, PDR and every specific route stayed below threshold; modality could not be stratified, no arm being antibiotic monotherapy. $\tau^2$ is zero in 11 cells, so intervals carry no between-arm variance. Conclusions: These proportions should not inform treatment decisions; the usable output is a map of what the published record cannot support.
\end{abstract}
