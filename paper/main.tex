...
Background: Multidrug-resistant (MDR), extensively drug-resistant (XDR), and pandrug-resistant (PDR) \textit{Pseudomonas aeruginosa} is a WHO priority pathogen with few options. Phage therapy has expanded from compassionate use to early-phase trials without resistance- or route-stratified synthesis. Methods: We conducted a PRISMA 2020 meta-analysis of proportions (random-effects binomial-normal GLMM), pooling clinical success, safety, eradication, and mortality across phage-therapy studies of MDR/XDR/PDR \textit{P.\ aeruginosa}, stratified by resistance category, route, and modality. Results: Twenty-eight pooling-eligible study-arms (23 studies, 106 patients) yielded a secondary clinical-success proportion of 76.9\% (95\% CI 64.4--86.0\%). Of 37 pre-specified strata, 16 met threshold, including a first resistance-specific estimate: MDR clinical success 74.3\% (95\% CI 55.4--87.0\%). XDR, PDR, most routes, and monotherapy remained below threshold. Egger's test was non-significant for clinical success, safety, and eradication but significant for mortality (p=0.02), consistent with fatal case reports clustering at the small-study end. Conclusions: A resistance-stratified MDR estimate is achievable; the MDR-versus-XDR comparison remains open.
\end{abstract}
