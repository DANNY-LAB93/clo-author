...
\node[wide] (elig) at (6.0,-6.3) {\textbf{Assessed for full-text eligibility: $n=33$ unique records} (5 citation-chased $+$ 8 via the PDF corpus $+$ 6 via discovery-phase scoping $+$ 9 new via the native Scopus search $+$ 5 held records re-confirmed against Scopus)};
\node[lbl] at (-2.4,-6.3) {ELIGIBILITY};

% --- Row 4: Excluded / Pending / Included, y = -9.1 ---
\node[box, text width=4.6cm, minimum height=4.3cm] (excl) at (0.6,-9.1) {\textbf{Excluded, $n=7$}\\$\bullet$ Krakhotkin 2025 -- wrong pathogen\\$\bullet$ Rhoads 2009 -- no antibiotic comparator\\$\bullet$ Dan 2023 -- duplicate (Aslam)\\$\bullet$ Van Nieuwenhuyse 2022 -- duplicate (Pirnay consortium)\\$\bullet$ Zurabov 2023 -- multi-pathogen, not separable\\$\bullet$ Hayakawa 2025 -- multi-pathogen feasibility\\$\bullet$ Chung 2025 -- review/perspective};
\node[box, text width=4.6cm, minimum height=4.3cm] (pend) at (6.0,-9.1) {\textbf{Pending / unresolved, $n=2$}\\$\bullet$ Karn 2024\\$\bullet$ Stanley 2025 (CYPHY)\\Conditionally eligible; outstanding, not dropped};
\node[box, text width=4.6cm, minimum height=4.3cm] (incl) at (11.4,-9.1) {\textbf{Included, $n=24$ studies}\\(29 study-arms)\\\smallskip Ten added by the native Scopus search (incl.\ K\"ohler 2023, Chan 2025, Law 2019, Li 2025)};
\node[lbl] at (-2.4,-9.1) {};

% --- Row 5: Quantitative synthesis, y = -13.0 ---
\node[wide] (synth) at (6.0,-13.0) {\textbf{Included in quantitative synthesis (pooling): $n=23$ studies, 28 study-arms.} 1 study (Leitner et al.\ 2021) retained in the analytic dataset but excluded from all pooling -- reported only as a six-pathogen, trial-wide aggregate with no \textit{Pseudomonas}-specific breakdown.};
