...
\node[wide] (elig) at (6.0,-6.3) {\textbf{Assessed for full-text eligibility: $n=\PrismaAssessed$ records} (derived as \PrismaIncludedStudies included $+$ \PrismaExcluded excluded). Channel of origin is documented for \PrismaItemised records across \PrismaChannelCount channels: \PrismaChannelList. The remaining \PrismaShortfall were not attributed to a channel at the time of screening and are not assigned to one here.};
