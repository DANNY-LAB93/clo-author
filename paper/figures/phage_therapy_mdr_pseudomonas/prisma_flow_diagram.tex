...
\node[box, text width=4.6cm, minimum height=4.6cm] (pend) at (6.0,-9.1) {\textbf{Reports not retrieved, $n=0$}\\Maddocks 2019 was in this category; its outcome data were recovered from two concordant secondary syntheses and it is now included\\\smallskip \textbf{Pending / unresolved, $n=0$}\\Karn 2024 and Stanley 2025 (CYPHY) were both resolved at peer review: Karn excluded as multi-pathogen with no \textit{Pseudomonas} breakdown, CYPHY identified as NCT04684641 and excluded under the population rule};
\node[box, text width=4.6cm, minimum height=4.6cm] (incl) at (11.4,-9.1) {\textbf{Included in the analytic dataset:}\\\textbf{$n=31$ studies, 38 study-arms}\\\smallskip Ten added by the native Scopus search (incl.\ K\"ohler 2023, Chan 2025, Law 2019, Li 2025); 2 landmark cases at peer review (Chan 2018, Arya 2026); 4 at peer review round 2 (Ferry 2021, Maddocks 2019, Aslam 2020, Cesta 2023, Khatami 2021)};
\node[lbl] at (-2.4,-9.1) {};

% --- Row 5: Quantitative synthesis, y = -13.0 ---
\node[wide] (synth) at (6.0,-13.0) {\textbf{Included in quantitative synthesis (pooling): $n=25$ studies, 31 study-arms.} Seven of the 38 analytic arms are excluded from all pooling, on four distinct grounds: Leitner et al.\ 2021 (1 arm; six-pathogen trial-wide aggregate with no \textit{Pseudomonas} breakdown); Liu et al.\ 2025 Patient 1 (1 arm; antibiogram below the MDR population criterion, the series' PDR patient retained); PhagoBurn, BX004-A and SWARM-P.a.\ (3 arms; trial populations recruited with no resistance entry criterion); and Ferry et al.\ 2022 and Racenis et al.\ 2023 (2 arms; probable duplicates of cases inside the Pirnay 2024 100-consecutive-case roster). Counts reconcile exactly against the cleaned extraction dataset and 02\_data\_preparation.R.};
