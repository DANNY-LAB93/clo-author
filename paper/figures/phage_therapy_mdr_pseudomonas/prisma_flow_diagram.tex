...
\node[wide] (elig) at (6.0,-6.3) {\textbf{Assessed for full-text eligibility: $n=\PrismaAssessed$ records} (derived as \PrismaIncludedStudies included $+$ \PrismaExcluded excluded). Channel of origin is documented for \PrismaItemised: 5 citation-chased $+$ 8 via the PDF corpus $+$ 6 via discovery-phase scoping $+$ 10 via the native Scopus search $+$ 5 held records re-confirmed $+$ 4 landmark cases flagged at peer review $+$ 2 further records named at peer review, round 2. The remaining \PrismaShortfall were not attributed to a channel at the time of screening and are not assigned to one here.};
\node[lbl] at (-2.4,-6.3) {ELIGIBILITY};

% --- Row 4: Excluded / Pending / Included, y = -9.1 ---
\node[box, text width=4.6cm, minimum height=4.6cm] (excl) at (0.6,-9.1) {\textbf{Excluded, $n=\PrismaExcluded$}\\$\bullet$ Krakhotkin 2025 -- wrong pathogen\\$\bullet$ Cano 2021 -- wrong pathogen (\textit{Klebsiella})\\$\bullet$ Rhoads 2009 -- no antibiotic comparator\\$\bullet$ Dan 2023 -- duplicate (Aslam)\\$\bullet$ Van Nieuwenhuyse 2022 -- duplicate (Pirnay consortium)\\$\bullet$ Zurabov 2023, Rubalskii 2020 -- multi-pathogen, not separable\\$\bullet$ Hayakawa 2025 -- multi-pathogen feasibility\\$\bullet$ Chung 2025 -- review/perspective\\$\bullet$ Karn 2024 -- multi-pathogen, no \textit{Pseudomonas} breakdown\\$\bullet$ Stanley 2025 (CYPHY, NCT04684641) -- population rule};
\node[box, text width=4.6cm, minimum height=4.6cm] (pend) at (6.0,-9.1) {\textbf{Reports not retrieved, $n=1$}\\Maddocks 2019: full text never obtained (paywalled, no PMC deposit). Outcome data were recovered from two concordant secondary syntheses, a weaker provenance than every other included study.\\\smallskip \textbf{Pending / unresolved, $n=0$}\\Karn 2024 and Stanley 2025 were both resolved at peer review and are counted among the exclusions at left.};
\node[box, text width=4.6cm, minimum height=4.6cm] (incl) at (11.4,-9.1) {\textbf{Included in the analytic dataset:}\\\textbf{$n=\PrismaIncludedStudies$ studies, \PrismaIncludedArms study-arms}\\\smallskip Ten added by the native Scopus search; 2 landmark cases at peer review (Chan 2018, Arya 2026); 5 at peer review round 2 (Ferry 2021, Maddocks 2019, Aslam 2020, Cesta 2023, Khatami 2021).};
\node[lbl] at (-2.4,-9.1) {};

% --- Row 5: Quantitative synthesis, y = -13.0 ---
\node[wide] (synth) at (6.0,-13.0) {\textbf{Included in quantitative synthesis (pooling): $n=\PrismaPooledStudies$ studies, \PrismaPooledArms study-arms.} Seven of the \PrismaIncludedArms analytic arms are excluded from all pooling, on four distinct grounds: Leitner et al.\ 2021 (1 arm; six-pathogen trial-wide aggregate with no \textit{Pseudomonas} breakdown); Liu et al.\ 2025 Patient 1 (1 arm; antibiogram below the MDR population criterion, the series' PDR patient retained); PhagoBurn, BX004-A and SWARM-P.a.\ (3 arms; trial populations recruited with no resistance entry criterion); and Ferry et al.\ 2022 and Racenis et al.\ 2023 (2 arms; probable duplicates of cases inside the Pirnay 2024 100-consecutive-case roster). Counts reconcile exactly against the cleaned extraction dataset and 02\_data\_preparation.R.};
