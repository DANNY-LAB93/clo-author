...
Safety (>=1 AE) -- Overall & GLMM (primary or NA if non-convergent) & 19.1\% [9.6\%, 34.4\%] \\
Safety (>=1 AE) -- Overall & Freeman-Tukey double-arcsine DL & 7.9\% [1.6\%, 17.2\%] \\
Safety (>=1 AE) -- Overall & Logit DerSimonian-Laird & 26.8\% [21.7\%, 32.7\%] \\
Safety (>=1 AE) -- Overall & Fixed-effect (logit) & 26.8\% [18.6\%, 37.0\%] \\
...
Mortality -- Overall & GLMM (primary or NA if non-convergent) & 10.5\% [5.4\%, 19.4\%] \\
Mortality -- Overall & Freeman-Tukey double-arcsine DL & 0.3\% [0.0\%, 6.1\%] \\
Mortality -- Overall & Logit DerSimonian-Laird & 22.0\% [15.8\%, 29.8\%] \\
Mortality -- Overall & Fixed-effect (logit) & 22.0\% [14.3\%, 32.3\%] \\
